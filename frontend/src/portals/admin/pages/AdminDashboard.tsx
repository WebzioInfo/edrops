...
export default function AdminDashboard() {
  ...
  return (
    <div className="space-y-3.5 sm:space-y-4">
      ...
      <AdminTopbar
        title="Dashboard"
        subtitle="System overview, operational metrics and quick actions"
      ...
      {/* ─── DASHBOARD BODY (KPI STAT CARDS & WATCHLIST) ──────── */}
      {loading && !data ? (
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="py-2 px-3 text-right">
                              <span
                                className={`inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold ${isZero
